...
/* baseadmin.html.twig */
class __TwigTemplate_07cd453a6cefe87e6c7ba8aa45ba06fe6a0a13a2c8d6c32470d37d61a3a0e5ed extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_top($context, array $blocks = [])
    {
        ...
        echo "\">Formations</a>
                    ...
                    <li class=\"nav-item\">
                        <a class=\"nav-link\" href=\"";
        // line 19
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin.niveaux");
        echo "\">Niveaux</a>
                    </li>
                </ul>
            </div>
...
";
    ...
    {
        return new Source("", "baseadmin.html.twig", "D:\\wamp\\www\\mediatekformationQ\\templates\\baseadmin.html.twig");
    }
}
